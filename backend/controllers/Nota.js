...
//         const admin = await Admin.findOne({
//             where : {
//                 [Op.and] : [{id : req.session.userId}, {kodeTokoAdm : req.session.kodeTokoAdm}]
//             }
//         });
...
//             response = await Nota.findAll({
//                 where : {
//                     [Op.and] : [{id : req.params.id}, {saleId : sales.id}]
//                 },
//                 include : [
//                 {
//                     model : Admin,
...
//             response = await Nota.findAll({
//                 where : {
//                     [Op.and] : [{id : req.params.id}, {adminId : req.session.userId}]
//                 },
//                 include : [
//                 {
//                     model : Admin,
